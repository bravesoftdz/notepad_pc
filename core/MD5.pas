...
function MD5En(M: AnsiString): AnsiString;
...
function AnsiMD5En(M: AnsiString): AnsiString;
begin
...
begin
	MD5Init(Context);
  WideStr:=WideString(N);
  PWideStr:=PWideChar(WideStr);

	FileHandle := CreateFileW(PWideStr, GENERIC_READ, FILE_SHARE_READ or FILE_SHARE_WRITE,
