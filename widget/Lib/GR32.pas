...
{$ENDIF}
    ...
    procedure RenderText(X, Y: Integer; const Text: string; AALevel: Integer; Color: TColor32); overload;
    procedure RenderText(DstRect: TRect; const Flags: Cardinal;
      const Text: String; Color: TColor32); overload;
    procedure RenderText(DstRect: TRect; const Flags: Cardinal;
      const Text: String; AALevel: Integer; Color: TColor32); overload;
...
procedure TBitmap32.RenderText(DstRect: TRect; const Flags: Cardinal;
...
begin
  ...
  try
    Sz := TextExtent(PaddedText);
    B.SetSize(DstRect.Right - DstRect.Left, DstRect.Bottom - DstRect.Top);
    B.Font := Font;
    B.Clear(0);
    ...
    B.DrawTo(Self, DstRect.Left, DstRect.Top);
  finally
    B.Free;
  end;
end;
...
procedure TBitmap32.RenderText(DstRect: TRect; const Flags: Cardinal;
  const Text: String; AALevel: Integer; Color: TColor32);
var
  B, B2: TBitmap32;
  Sz: TSize;
  Alpha: TColor32;
...
begin
  if Empty then
    Exit;
  SetFontAntialiasing(Font, AALevel);
  Alpha := Color shr 24;
  Color := Color and $00FFFFFF;
  PaddedText := Text + ' ';
  B := TBitmap32.Create;
