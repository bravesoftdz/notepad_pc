...
{$ENDIF}
  ...
  protected
    procedure BitmapAreaChanged(Sender: TObject; const Area: TRect; const Info: Cardinal); virtual;
    function DoHitTest(X, Y: Integer): Boolean; override;
...
type
  TImage32Access = class(TCustomImage32_ml);
...
begin
  ...
  if Cropped and (LayerCollection.FOwner is TCustomImage32_ml) and
  ...
  begin
    ...
    ImageRect := TCustomImage32_ml(LayerCollection.FOwner).GetBitmapRect;
