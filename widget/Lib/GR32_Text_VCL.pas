...
begin
  ...
  begin
    ...
    CurvePtr := PTTPolyCurve(Integer(BufferPtr) + SizeOf(TTTPolygonHeader));  
    {$ENDIF}
    ...
    begin
      ...
      {$ELSE}
        ...
        CurvePtr := PTTPolyCurve(Integer(CurvePtr) + K);  
      {$ENDIF}
    end;
    ...
    {$ELSE}
      ...
      BufferPtr := PTTPolygonHeader(Integer(BufferPtr) + BufferPtr.cb);  
    {$ENDIF}
  end;
