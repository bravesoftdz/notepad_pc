...
type
  ...
  public
    ...
    procedure DoPaint(ABuffer: TBitmap32; AInvalidRects: TRectList; ACanvas: TCanvas; APaintBox: TWidgetPaintBox32);
...
procedure TGDIBackend.DoPaint(ABuffer: TBitmap32; AInvalidRects: TRectList;
  ACanvas: TCanvas; APaintBox: TWidgetPaintBox32);
var
  i: Integer;
begin
...
procedure TGDIMemoryBackend.DoPaint(ABuffer: TBitmap32;
  AInvalidRects: TRectList; ACanvas: TCanvas; APaintBox: TWidgetPaintBox32);
var
  i : Integer;
begin
  if AInvalidRects.Count > 0 then
